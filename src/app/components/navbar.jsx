          ...
          <div className="container mx-auto">
            ...
            <div className="flex justify-end p-4 gap-2">
              <button 
                ...
                className="p-2 w-[42px] h-[42px] rounded-[6px] border border-[rgba(0,0,0,0.15)] bg-[rgba(0,136,255,0.91)] flex items-center justify-center shadow-[inset_0px_0px_6px_3px_rgba(255,255,255,0.60)] backdrop-blur-[7px]"
              >
