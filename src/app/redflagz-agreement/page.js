...
function RedflagzAgreementContent() {
	const searchParams = useSearchParams()
	const contractType = searchParams.get('type') || 'default'

	const appConfig = getAppConfig('redflagz')
	const contract = getContractConfig('redflagz', contractType)
...
export default function RedflagzAgreementPage() {
	return (
		<Suspense fallback={
			<div className="min-h-screen bg-gray-50 flex items-center justify-center">
