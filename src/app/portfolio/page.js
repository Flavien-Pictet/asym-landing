...
export default function Portfolio() {
  ...
  const INITIAL_DOWNLOADS = 1400000;
        ...
        <div className="flex-1 px-5 pt-[200px] max-w-[1200px] mx-auto">
          ...
          >
            ...
            <div className="border-b-[1.5px] border-dashed border-[#E5E5E5] first:border-t-[1.5px]">
              ...
              >
                <div className="pb-6 text-[#B2B2B2] text-[14px] font-['Rethink_Sans'] font-medium select-none">
                  <p className="mb-3">Estimate and track your testosterone levels, libido & energy in real-time & maximize it by following your personalized daily routine to optimize hormone balance.</p>
                  <div className="inline-block px-3 py-1" style={{ borderRadius: '6px', border: '1px solid #E4E7EC' }}>
            ...
            <div className="border-b-[1.5px] border-dashed border-[#E5E5E5] first:border-t-[1.5px]">
              ...
              >
                <div className="pb-6 text-[#B2B2B2] text-[14px] font-['Rethink_Sans'] font-medium select-none">
                  <p className="mb-3">Want to elevate your makeup game effortlessly? Gloss AI is your personal beauty coach, helping you analyze, improve & master your look with the power of AI.</p>
                  <div className="inline-block px-3 py-1" style={{ borderRadius: '6px', border: '1px solid #E4E7EC' }}>
                    <span className="text-[14px] text-black">No PMF</span>
                  </div>
                </div>
