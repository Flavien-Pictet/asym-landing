          ...
          <div className="px-5 min-h-screen" style={{ paddingBottom: '100px' }}>
            <div className="max-w-[800px] mx-auto">
              ...
              <motion.h3
                ...
                className="mt-[25px] mb-[25px] lg:mt-[30px] lg:mb-[30px] text-[20px] lg:text-[18px] font-['Recoleta'] text-black font-bold lg:font-bold leading-[1.1] lg:leading-normal"
              >
              ...
              >
                ...
                <motion.h3
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: 0.6 }}
                  className="mt-[25px] mb-[25px] lg:mt-[30px] lg:mb-[30px] text-[20px] lg:text-[18px] font-['Recoleta'] text-black font-bold lg:font-bold"
                >
